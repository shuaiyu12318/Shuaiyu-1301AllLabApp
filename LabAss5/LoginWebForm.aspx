...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" ErrorMessage="Invaild Password"></asp:RequiredFieldValidator>
        </p>
